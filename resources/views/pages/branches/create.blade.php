...
@section('title') @lang('site.branches') @endsection

@section('links')
<li class="breadcrumb-item"><a href="{{ route('branches.index') }}">@lang('site.branches')</a></li>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="@lang('site.branch_name')">
                            </div>
                        </div>
