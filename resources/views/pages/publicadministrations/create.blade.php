...
<div class="row">
    <div class="col-md-12">
        <div class="card card-primary">
            <div class="card-body">
                <form action=" {{route('publicadministrations.store')}} " method="post" id="submit">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                            <!-- name of public administration -->
                            <div class="form-group">
                                <label for="name">@lang('site.publicadministration_name')</label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror " id="name" name="name" @error('name')aria-invalid="true"@enderror  placeholder="@lang('site.publicadministration_name')" required>
