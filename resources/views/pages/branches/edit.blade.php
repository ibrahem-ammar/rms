...
<div class="row">
    <div class="col-md-12">
        <div class="card card-primary">
            <div class="card-body">
                <form action=" {{route('branches.update',['branch'=>$branch->id])}} " method="post" id="submit">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control
                                    ...
                                    placeholder="@lang('site.branch_name')" required>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="user_id" id="user_id" required>
                                    ...
                                    @forelse ($users as $user)
                                        <option value="{{ $user->id }}" {{($branch->manager->id == $user->id) ? 'selected' : ''}}>{{ $user->name }}</option>
                                    @empty
