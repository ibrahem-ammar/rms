                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="administration_id">@lang('site.administration')</label>
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="department_id">@lang('site.department')</label>
                                <select class="form-control select2" name="department_id" id="department_id" required>
                                    <option value="" selected disabled hidden>@lang('site.select_department')</option>
